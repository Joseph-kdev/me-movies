            ...
            <div className='movie-poster'>
                ...
                <div className="heroinIcons">
                    {movieInCollections.favorites ? 
                        ...
                        xmlns="http://www.w3.org/2000/svg" fill="red" strokeWidth={1.5} stroke="white" className="w-6 h-6" width="24px" height="24px">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                      </svg>
                      ) :
                       <svg onClick={() => toggleMovieCollection('favorites',"add") }
                       xmlns="http://www.w3.org/2000/svg" fill="none" strokeWidth={1.5} stroke="white" className="w-6 h-6" width="24px" height="24px">
                       <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                     </svg>
                     }
                </div>
            ...
            <div id='movie-details'>
                ...
                {!movieInCollections.watched && (
                                    ...
                                    {movieInCollections.watchlist && !movieInCollections.watched && (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="grey" className="w-6 h-6" width='24' height='24'>
                                    ...
                                    {movieInCollections.watchlist ? (
                                        <button onClick={() => toggleMovieCollection('watchlist', "remove")} ><svg xmlns="http://www.w3.org/2000/svg" fill="red" className="w-6 h-6" width="24px" height="24px">
                                        <path fillRule="evenodd" d="M4.25 12a.75.75 0 0 1 .75-.75h14a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75Z" clipRule="evenodd" />
                                      </svg>
                                      </button>
                                    ) : (
                                        <button onClick={() => toggleMovieCollection('watchlist',"add")} disabled={movieInCollections.watched}><svg xmlns="http://www.w3.org/2000/svg" fill="blue" className="w-6 h-6" width="24px" height="24px">
                ...
                {!movieInCollections.watchlist && ( 
                                    ...
                                    {movieInCollections.watched ? (
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="green" className="w-6 h-6" width="24px" height="24px">
