...
export const Movie = ({
  ...
  const limitedOverview =
    overview.substring(0, 160) + (overview.length > 160 ? "..." : "");
  ...
  return (
    <>
      <div className="movie">
        <div className="movie-poster"  ref={ref} data-in-view="false">
          <img
          ...
          <div className="heroinIcons favorite">
            {movieInCollections.favorites ? (
              <svg
                onClick={() => toggleMovieCollection("favorites", "remove")}
              ...
              <svg
                onClick={() => toggleMovieCollection("favorites", "add")}
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                strokeWidth={1.5}
                stroke="#a3dcbc"
