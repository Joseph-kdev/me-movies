...
export const Carousel = () => {
  ...
  const images = [
    ...
    { id: 872585, src: "/images/oppenheimer.jpg" },
  ];

  const editorsChoiceIds = [293660, 546554, 13, 372058, 157336, 359724, 569094, 872585];
  ...
  const isLoading =
    queryResults && queryResults.some((result) => result.isLoading);
